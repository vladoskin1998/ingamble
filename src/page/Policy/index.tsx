                                ...
                                <div className="main-privacy-policy__body">
                                    <div className="main-privacy-policy__item">
                                        <p>
                                            At <a href="" target="_blank"
                                                aria-label="Put your description here.">inGamble.com</a>, we are
                                        ...
                                        <p>
                                            We reserve the right to change this Privacy Policy at any given time, of
                                            which you will be promptly updated. If you want to make sure that you are up
                                        ...
                                        <ul className="main-privacy-policy__list">
                                            <li className="main-privacy-policy__list-item">
                                                ...
                                                <ul className="main-privacy-policy__sublist">
                                                    <li className="main-privacy-policy__sublist-item">
                                                        Email address;
                                                    </li>
                                                    <li className="main-privacy-policy__sublist-item">
                                                    ...
                                                    <li className="main-privacy-policy__sublist-item">
                                                        Bank account information for payment of products and/or services
                                                        under the Service;
                                                    </li>
                                                    <li className="main-privacy-policy__sublist-item">
                                                        Date of birth.
                                            ...
                                            <li className="main-privacy-policy__list-item">
                                                <span>
                                                    When you pay for a product and/or service by wire transfer, we may
                                                    ask
                                                    you to provide information to facilitate the transaction and verify
                                                    your
                                                    identity. Such information may include, but is not limited to:
                                                </span>
                                                <ul className="main-privacy-policy__sublist">
                                                    <li className="main-privacy-policy__sublist-item">
                                            ...
                                            <li className="main-privacy-policy__list-item">
                                                <span>
                                                    ...
                                                    website, including your IP address, browser type, referring/exit
                                                    pages,
                                            ...
                                            <li className="main-privacy-policy__list-item">
                                                <span>
                                                    ...
                                                    Please see our <a href="" target="_blank"
                                                        aria-label="Put your description here.">Cookie Policy</a> for
                                                    more
                                                    details.
                                                </span>
                                            </li>
                                    ...
                                    <div className="main-privacy-policy__item">
                                        ...
                                        <ul className="main-privacy-policy__list main-privacy-policy__list_small">
                                            ...
                                            <li className="main-privacy-policy__list-item">
                                                <span>
                                                    To detect, prevent, and address technical issues and fraudulent or
                                                    illegal activities.
                                                </span>
                                            </li>
                                            <li className="main-privacy-policy__list-item">
                                                <span>
                                                    To compile aggregate data for internal and external business
                                                    purposes.
                                                </span>
                                            </li>
                                        </ul>
                                    ...
                                    <div className="main-privacy-policy__item">
                                        ...
                                        <p>
                                            ...
                                            service providers are obligated to keep your information confidential and
                                        ...
                                        <p>
                                            ...
                                            legal obligations, protect and defend our rights or property, or act in
                                            urgent circumstances to protect the personal safety of our users or the
                                            public.
                                        </p>
                                    </div>
                                    <div className="main-privacy-policy__item">
                                    ...
                                    <div className="main-privacy-policy__item">
                                        ...
                                        <span>
                                            For users residing in the European Economic Area (EEA), we comply with
                                            the General Data Protection Regulation (GDPR). Under the GDPR, you have
                                        ...
                                        <p>
                                            ...
                                            provided in the "Contact Us" section below. We will respond to your request
                                            within 30 days.
                                        </p>
                                    </div>
                                    <div className="main-privacy-policy__item">
                                        ...
                                        <p>
                                            ...
                                            practices, please contact us at <a href="mailto:support@ingamble.com"
                                                target="_blank"
                                                aria-label="Put your description here.">support@ingamble.com</a>.
                                        </p>
                                        <p>
