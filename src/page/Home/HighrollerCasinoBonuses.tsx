...
export default function HighrollerCasinoBonuses () {
    ...
    return (
        <section className="main-gamble__new-bonuses new-bonuses-gamble   main-gamble__fastest-payout-casinos fastest-payout-casinos-gamble">
                    ...
                    <div className="top__row">
                        <div className="top__column">
                            <div className="top__title-block">
                                ...
                                <h2 className="top__title">Highroller Casino Bonuses</h2>
                            </div>
                        </div>
                        <div className="top__column">
                            <a
                                 href="/see-all?key=90123456"
