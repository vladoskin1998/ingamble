...
const baseURL = window.location.origin.includes('cryptogamblers') ? `https://cg-api-prod.incasinowetrust.com/api/v1/` : 'https://ig-api-prod.incasinowetrust.com/api/v1/' ;
