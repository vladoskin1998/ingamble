...
export const CasinoPlayersFromContent = memo(({
    ...
    const checkboxItem = (id: number) => {
        setLocalCasinoFilters(prevFilters => {
            ...
            return {
                ...prevFilters,
                selected_countries: isSelected
                    ? prevFilters?.selected_countries?.filter(item => item !== id)
                    : [...prevFilters?.selected_countries, id],
            };
        });
                        ...
                        {({ index, style }) => {
                            ...
                            return (
                                <div className="radio-form-filter__item" style={style}>
                                    <input
                                        id={`formFilterPlayersFrom${country?.name}`}
                                        type="checkbox"
                                        checked={isChecked}
                                    ...
                                    />
                                    <label
                                        htmlFor={`formFilterPlayersFrom${country?.name}`}
